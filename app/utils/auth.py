"""
Authentification + gestion des comptes du portail ShopPulse.
...
# - Agent       : accès complet (Power BI, Prévision, Risque de retour, Chatbot) mais pas la gestion des comptes
...
def _default_users() -> dict:
    return {
        "admin": {
            ...
            "name": "Administrateur",
            "role": "Admin",
            "email": "admin@shoppulse.tn",
        },
        "agent": {
            "password": _hash("agent2025"),
            "name": "Agent ShopPulse",
            "role": "Agent",
            "email": "agent@shoppulse.tn",
        },
    }
