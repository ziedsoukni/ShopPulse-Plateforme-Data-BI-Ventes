...
st.markdown(
    ...
    - **Agent** : accès complet aux modules métier (Power BI, Prédiction, Détection de fraude, Chatbot).
    ...
    with col:
        st.markdown(
            ...
            <div class="stb-card" style="text-align:center;">
                <div class="stb-kpi-label">{role}</div>
                <div class="stb-kpi-value">{role_counts.get(role, 0)}</div>
            </div>
            """,
