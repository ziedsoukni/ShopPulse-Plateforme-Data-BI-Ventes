"""Prévision du montant total mensuel des transactions (Holt-Winters + SARIMA).

Adapté du script `Untitled-1.py` du projet PFE pour une intégration directe
...
# ------------------------------------------------------------------------
FICHIER_EXCEL_DEFAUT = r"C:\Users\user\Downloads\donnees_PFE_BI_Talend_reduit.xlsx"
FEUILLE = "TRANSACTION"
COLONNE_DATE = "date"
