...
EXCEL_PATH_DEFAUT = r"C:\Users\user\Desktop\github\Plateforme Data & BI -- Detection de Fraude\donnees_ventes_ecommerce.xlsx"
...
def load_data(source):
    ...
    # marge par ligne de vente (utile pour les questions de rentabilité)
